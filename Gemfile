...
# 002 The following gems are added.
# This gets the bootstrap scss and js files.
gem 'bootstrap-sass'
# This gets the font-awesome scss.
gem 'font-awesome-sass'
# This is to get install simple form.
gem 'simple_form'
# This will add vendor prefixed into the scss.
gem 'autoprefixer-rails'
# 003 'bundle install' @terminal / To install the gems I've added so far.
# 004 'rails generate simple_form:install --bootstrap' @terminal / To generate the configs for simple form for bootstrap.
